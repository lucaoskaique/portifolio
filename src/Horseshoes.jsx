...
function Horseshoe({ index, z, speed }) {
  const ref = useRef();
...
export default function Horseshoes({
  speed = 1,
  count = 80,
  depth = 80,
  ...
  return (
    ...
    >
      ...
      {Array.from(
        { length: count },
        (_, i) => <Horseshoe key={i} index={i} z={Math.round(easing(i / count) * depth)} speed={speed} /> /* prettier-ignore */
      )}
